...
document.addEventListener("nav", () => {
  ...
  const loadGiscus = () => {
    INTERACTION_EVENTS.forEach((e) => window.removeEventListener(e, loadGiscus))
  ...
  INTERACTION_EVENTS.forEach((e) => window.addEventListener(e, loadGiscus, { once: true, passive: true }))
  window.addCleanup(() => INTERACTION_EVENTS.forEach((e) => window.removeEventListener(e, loadGiscus)))
})
